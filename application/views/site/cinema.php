<div style="margin-top: 55px;" class="container">
    <div class="row">
        ...
        <div class="col-9" style="margin-top: 30px;">
            ...
            <? //= $data["wallpapers"][0]["img"]; ?><!--"-->
            <!--                                 alt="First slide">-->
            <!--                            <div class="mask rgba-black-light"></div>-->
            <!--                        </div>-->
            <!--                        <div class="carousel-caption">-->
            <!--                            <h3 class="h3-responsive">-->
            <? //= $data["wallpapers"][0]["text"] ?><!--</h3>-->
            <!--                        </div>-->
            <!--                    </div>-->
            ...
            <!--                        <div class="view">-->
            <!--                            <img class="d-block w-100" src="../../../assets/img/-->
            <? //= $data["wallpapers"][1]["img"]; ?><!--"-->
            <!--                                 alt="Second slide">-->
            <!--                            <div class="mask rgba-black-strong"></div>-->
            <!--                        </div>-->
            <!--                        <div class="carousel-caption">-->
            <!--                            <h3 class="h3-responsive">-->
            <? //= $data["wallpapers"][1]["text"] ?><!--</h3>-->
            <!--                        </div>-->
            <!--                    </div>-->
            <!--                    <div class="carousel-item">-->
            <!--                        <!--Mask color-->
            <!--                        <div class="view">-->
            <!--                            <img class="d-block w-100" src="../../../assets/img/-->
            <? //= $data["wallpapers"][2]["img"]; ?><!--"-->
            <!--                                 alt="Third slide">-->
            <!--                            <div class="mask rgba-black-slight"></div>-->
            <!--                        </div>-->
            <!--                        <div class="carousel-caption">-->
            <!--                            <h3 class="h3-responsive">-->
            <? //= $data["wallpapers"][2]["text"] ?><!--</h3>-->
            <!---->
            <!--                        </div>-->
            <!--                    </div>-->
            <!--                </div>-->
            ...
            <div class="row">
                <?php
                foreach ($data["movies"] as $v) {
                    foreach ($v as $value) { ?>
                        <div class="col-lg-4 col-md-6 mb-4 film-data" data-id="<?= $value["id"] ?>">
                            <div class="card h-100"
                                 style="background-color: #dddddd; margin-top: 2px;margin-bottom: 2px;">
                                <a href="/movies/<?= $value["id"] ?>"><img style="height: 300px; width: 100%;" class=""
                                                                           src="../../../assets/img/<?= $value["img"] ?>"
                                                                           alt="LOGO"></a>
                                <div class="card-body">
                                    <h4 class="card-title d-flex">
                                        <div>
                                            <a href="/movies/<?= $value["id"] ?>"
                                               class="btn btn-outline-secondary"><?= $value["name"] ?></a>
                                        </div>
                                    </h4>
                                </div>
                            </div>
